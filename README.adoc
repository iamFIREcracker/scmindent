...
- It does not leave trailing whitespaces when indenting empty lines
  (https://github.com/ds26gte/scmindent/pull/9[read more])
- It properly skips commented out lines when indenting sub-forms
  (https://github.com/ds26gte/scmindent/pull/10[read more])
